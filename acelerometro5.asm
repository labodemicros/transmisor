...
.equ	MOT_THR = 0x1F		; registro de umbral de movimiento	
.equ	INT_PIN_CFG = 0x37	; registro de configuracion del pin INT para interrupciones
.equ	INT_EN = 0x38	; registro para configurar la fuente de interrupciones
...
;SBI		PORTB,2	; Configuramos el pull-up del pin 2 del puerto B.
...
; Seteamos una frecuencia de CYCLE de 1.25 Hz.																								 
...
　
; Configuramos un umbral de deteccion de movimiento en el valor maximo 255.																 
;LDI		reg_address,MOT_THR																											 
;LDI		data,0xFF																													 
;RCALL	I2C_WRITE_DATA																													 
